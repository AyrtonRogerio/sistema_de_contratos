...
class Enderecos(admin.ModelAdmin):
    list_display = ('id', 'logradouro', 'numero', 'cep',
...
class Contratos(admin.ModelAdmin):
    list_display = ('id', 'descricao', 'valor_total',
                    'qtd_nota_promissoria', 'empresa_id', 'cliente_id')
...
class NotasPromissorias(admin.ModelAdmin):
    list_display = ('id', 'contrato_id', 'valor')
    list_display_links = ('id', 'contrato_id', 'valor')
